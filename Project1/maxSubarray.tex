	...
	\section{Mathematical Analysis}
		...
		\subsection{Algorithm 3}
			\begin{algorithm}[H]
				...
				\DontPrintSemicolon
				\SetKwData{Sums}{sums}
				\SetKwFunction{MSr}{MaxSubarray\_rec}
				...
				\begin{algorithm}[H]
					\SetKwData{A}{A}
					\SetKwData{LS}{left\_sums}
					\SetKwData{RS}{right\_sums}
					\SetKwData{LB}{left\_branch}
					\SetKwData{RB}{right\_branch}
					\SetKwData{All}{all}
					\SetKwData{Left}{left}
					\SetKwData{Right}{right}
					\SetKwData{Overall}{overall}
					...
					\Sums.\Left = \Max(\LS.\Left, \LS.\All + \RS.\Left)\;   % Don't have to compare left_sums.all here, since left_sums.left may include it.
